...
gulp.task ('move', function() {
    return gulp.src(['bower_components/jquery/dist/jquery.js', 'bower_components/jquery-validate/dist/jquery.validate.js', 'bower_components/jquery-placeholder/jquery.placeholder.js' ])
        .pipe(uglify())
        .pipe(rename({
          suffix: '.min'
        }))
